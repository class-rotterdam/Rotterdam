This End-User License Agreement (the *EULA*) is a legal agreement between the *Licensee*, an individual, and Atos Spain S.A. Unipersonal (the *Company*), the author of **Rotterdam** (the *Software*), which may include associated media, printed materials, and *online* or electronic documentation.
...
- *Software* shall mean **Rotterdam** (optional) the deliverables provided pursuant to this *EULA*.
2.	**Grant of License**

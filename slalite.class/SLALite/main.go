...
import (
	...
	"SLALite/assessment/notifier/rotterdamnotifier"
	"SLALite/model"
...
func main() {
	...
	if repo != nil {
		...
		// rotterdamnotifier
		var en rotterdamnotifier.ExportNotifier
		// using prometheusadapter
		go createValidationThread(repo, prometheusadapter.New(1), en, checkPeriod)
		a.Run()
	}
}
